...
const Banner = () => {
    return (
        <section className=' bg-red-300 h-[60vh] mt-[14vh] bg-cover bg-top' style={{ backgroundImage: `url(${BannerImage})` }}>
            <div className='max-w-[1300px] mx-auto px-12 h-100 flex flex-col justify-center gap-4'>
                <h1 className='text-red-600 text-9xl font-bold tracking-tight'> Big Sale!</h1>
